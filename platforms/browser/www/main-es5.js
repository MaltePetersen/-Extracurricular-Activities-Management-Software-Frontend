...
var map = {
	"./pages/betreuer/betreuer-dashboard/betreuer-dashboard.module": [
		"./src/app/pages/betreuer/betreuer-dashboard/betreuer-dashboard.module.ts",
		"pages-betreuer-betreuer-dashboard-betreuer-dashboard-module"
	],
	"./pages/erziehungsberechtigte/erziehungsberechtigte-dashboard/erziehungsberechtigte-dashboard.module": [
		"./src/app/pages/erziehungsberechtigte/erziehungsberechtigte-dashboard/erziehungsberechtigte-dashboard.module.ts",
		"pages-erziehungsberechtigte-erziehungsberechtigte-dashboard-erziehungsberechtigte-dashboard-module"
	],
	"./pages/fjoerdeLeitung/fjoerde-leitung-dashboard/fjoerde-leitung-dashboard.module": [
...
var routes = [
    ...
    },
    {
        ...
        loadChildren: './pages/fjoerdeLeitung/fjoerde-leitung-dashboard/fjoerde-leitung-dashboard.module#FjoerdeLeitungDashboardPageModule',
        canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
    },
    {
        path: 'betreuer-dashboard',
        loadChildren: './pages/betreuer/betreuer-dashboard/betreuer-dashboard.module#BetreuerDashboardPageModule',
        canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
    },
    {
...
var AuthenticationService = /** @class */ (function () {
    function AuthenticationService(storage, router) {
        this.storage = storage;
        this.router = router;
        this.authenticationState = new rxjs__WEBPACK_IMPORTED_MODULE_2__["BehaviorSubject"](null);
        this.user = this.authenticationState.asObservable();
    }
    AuthenticationService.prototype.login = function (credentials) {
        var email = credentials.email;
        var pw = credentials.pw;
        var user = null;
        if (email === 'leitung' && pw === 'leitung') {
            user = { email: email, role: 'LEITUNG' };
        }
        else if (email === 'betreuer' && pw === 'betreuer') {
            user = { email: email, role: 'BETREUER' };
        }
        else if (email === 'eltern' && pw === 'eltern') {
            user = { email: email, role: 'ERZIEHUNGSBERECHTIGTE' };
        }
    ...
    AuthenticationService.prototype.logout = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.storage.set(TOKEN_KEY, null)];
                    case 1:
                        _a.sent();
...
module.exports = __webpack_require__(/*! C:\Users\hgarn\Documents\fjoerde\src\main.ts */"./src/main.ts");
