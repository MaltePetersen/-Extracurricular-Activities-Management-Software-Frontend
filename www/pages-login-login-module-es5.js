...
var LoginPage = /** @class */ (function () {
    ...
    LoginPage.prototype.login = function () {
        ...
        this.auth.login(this.user).subscribe(function (user) {
            ...
            var role = user['role'];
            if (role === 'LEITUNG') {
                _this.router.navigateByUrl('/fjoerde-leitung-dashboard');
            }
            else if (role === 'BETREUER') {
                _this.router.navigateByUrl('./../../betreuer/betreuer-dashboard');
            }
            else if (role === 'ERZIEHUNGSBERECHTIGTE') {
                _this.router.navigateByUrl('./../../erziehungsberechtigte/erziehungsberechtigte-dashboard');
            }
        });
    };
